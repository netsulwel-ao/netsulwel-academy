...
export default function InstitutionSettingsPage() {
  ...
  if (loading) {
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <div className="h-96 bg-gray-800/40 animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl space-y-8 animate-in fade-in duration-300">
      ...
      {/* ── Cabeçalho ── */}
      <div>
        <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-purple/60 mb-2">// definições</p>
      ...
      {institution && (
        <div className="flex items-center gap-3 border border-gray-800/60 bg-gray-900/10 px-4 py-3">
          ...
          <div>
            <p className="font-mono text-[9px] uppercase tracking-widest text-gray-600">Estado</p>
      ...
      {/* ── Formulário ── */}
      <div className="border border-gray-800/60 bg-gray-900/10 p-6 space-y-6">
        <p className="font-mono text-[10px] uppercase tracking-widest text-gray-700 pb-4 border-b border-gray-800/40">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// logótipo</p>
            {logo ? (
              <div className="relative group w-24 h-24">
                <img src={logo} alt="Logótipo" className="w-24 h-24 object-cover border border-gray-800/60" />
                <button
                  type="button" onClick={() => setLogo("")}
                  className="absolute top-1 right-1 border border-red-500/30 bg-gray-950/90 px-2 py-0.5 font-mono text-[8px] text-red-400/80 opacity-0 group-hover:opacity-100 transition-opacity"
                >
                  Remover
                </button>
              </div>
              ...
              <button
                ...
                className="flex h-24 w-24 flex-col items-center justify-center border border-dashed border-gray-700 bg-gray-900/20 hover:border-purple/30 transition-colors cursor-pointer"
              >
          ...
          <div>
            <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// banner</p>
            {banner ? (
              <div className="relative group">
                <img src={banner} alt="Banner" className="w-full h-20 object-cover border border-gray-800/60" />
                <button
              ...
              <button
                ...
                className="flex h-20 w-full flex-col items-center justify-center border border-dashed border-gray-700 bg-gray-900/20 hover:border-purple/30 transition-colors cursor-pointer"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="sm:col-span-2">
            <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2 flex items-center gap-1.5">
        ...
        <div className="pt-4 border-t border-gray-800/40 flex justify-end">
          <button
            ...
            className="flex items-center gap-1.5 border border-purple/25 bg-purple/8 px-6 py-2.5 font-mono text-[10px] uppercase tracking-widest text-purple/80 hover:bg-purple/15 disabled:opacity-40 transition-all"
          >
