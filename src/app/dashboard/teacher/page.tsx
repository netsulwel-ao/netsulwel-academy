    ...
    <div className="max-w-6xl mx-auto animate-in fade-in duration-500 space-y-8">
      ...
      <div className="bg-gray-900/40 border border-gray-800">
        <div className="p-6 border-b border-gray-800 flex items-center justify-between">
          ...
          <Link href="/admin/courses" className="text-sm text-purple hover:text-purple-light">Ver todos</Link>
        </div>
        {courses.length === 0 ? (
          <div className="p-12 text-center">
            <BookOpen className="h-12 w-12 text-gray-600 mx-auto mb-4" />
            <p className="text-gray-400">Ainda não criaste nenhum curso.</p>
            <Link href="/admin/courses/new" className="mt-4 inline-flex items-center gap-2 text-sm text-purple hover:text-purple-light font-bold">
          ...
          <div className="divide-y divide-gray-800">
            {courses.slice(0, 5).map((course) => (
              <Link key={course.id} href={`/admin/courses/${course.id}`} className="block p-6 hover:bg-gray-800/30 transition-colors">
