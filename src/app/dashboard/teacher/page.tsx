    ...
    <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      {!hasContent && (
        <div className="border border-gray-800 bg-gray-900 p-10 text-center">
          ...
          <p className="font-mono text-[13px] uppercase tracking-widest text-gray-700 mb-3">primeiros passos</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <Link
              key={href}
              href={href}
              className={`group flex items-center gap-4 border bg-gray-900 p-4 transition-all ${accent}`}
            >
      ...
      {hasContent && (
        <div className="border border-gray-800">
          <div className="flex items-center justify-between border-b border-gray-800 px-5 py-4">
            <p className="font-mono text-[13px] uppercase tracking-widest text-gray-600">cursos recentes</p>
            <Link href="/dashboard/teacher/courses" className="flex items-center gap-1 text-sm text-gray-600 hover:text-gray-400 transition-colors">
          ...
          <div className="divide-y divide-gray-800">
            {courses.slice(0, 5).map((course) => (
              <Link
                ...
                className="group flex items-center gap-4 px-5 py-4 hover:bg-gray-900 transition-colors"
              >
                <div className="h-14 w-20 shrink-0 overflow-hidden bg-gray-900 border border-gray-800">
                  {course.thumbnail ? (
      ...
      {sales.length > 0 && (
        <div className="border border-gray-800">
          <div className="flex items-center justify-between border-b border-gray-800 px-5 py-4">
            ...
            <Link href="/dashboard/wallet" className="flex items-center gap-1 text-sm text-gray-600 hover:text-gray-400 transition-colors">
