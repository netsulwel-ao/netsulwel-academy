      ...
      {!loading && exams.length > 0 && (
        <div className="border border-gray-800 divide-y divide-gray-800">
          {exams.map(exam => (
            <div
              key={exam.id}
              className="flex flex-col sm:flex-row sm:items-center gap-4 px-5 py-4 hover:bg-gray-900 transition-colors"
            >
              {/* Info */}
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-2 mb-1">
                  <h3 className="text-sm font-bold text-gray-200">{exam.title}</h3>
                  <span className="font-mono text-[13px] uppercase tracking-widest border border-gray-800 bg-gray-900 px-2 py-0.5 text-gray-600">
                  ...
                  {exam.timeLimit && (
                    <span className="flex items-center gap-1 font-mono text-[13px] uppercase tracking-widest border border-gray-800 bg-gray-900 px-2 py-0.5 text-gray-600">
              ...
              <div className="flex items-center gap-2 shrink-0 flex-wrap">
                <Link
                  ...
                  className="flex items-center gap-1.5 border border-gray-800 bg-gray-900 px-3 py-2 font-mono text-[13px] uppercase tracking-widest text-gray-500 hover:border-gray-700 hover:text-gray-300 transition-all"
                >
