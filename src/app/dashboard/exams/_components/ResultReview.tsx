    ...
    <div className="space-y-3">
      {exam.questions.map((q, i) => {
        ...
        return (
          ...
          >
            {/* Cabeçalho */}
            <div className="flex items-center gap-3 border-b border-gray-800/30 px-4 py-2.5">
              {correct
                ...
                <div className="space-y-1.5">
                  {q.options.map((opt, oi) => {
                    ...
                    return (
                      ...
                      >
                        <span className="font-mono text-[9px] w-4 shrink-0">
                      ...
                      <div
                        ...
                        className={`flex items-center gap-1.5 px-3 py-2 text-xs ${
                          isCorrect
                            ...
                            : isUser && !isCorrect
                            ? "bg-red-500/8 border border-red-500/20 text-red-400/70"
                            : "text-gray-600 border border-gray-800/40"
                        }`}
                      >
                        {isCorrect && <CheckCircle2 className="h-3 w-3 shrink-0" strokeWidth={1.5} />}
                        {isUser && !isCorrect && <XCircle className="h-3 w-3 shrink-0" strokeWidth={1.5} />}
