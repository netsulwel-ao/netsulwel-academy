          ...
          >
            ...
            <div className="flex items-center gap-3 border-b border-gray-800 px-4 py-2.5">
              {correct
                ...
                : <XCircle    className="h-3.5 w-3.5 text-red-400 shrink-0" strokeWidth={1.5} />
              }
              ...
              <span className={`ml-auto font-mono text-[13px] uppercase tracking-widest ${
                correct ? "text-green" : "text-red-400"
              }`}>
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center gap-2.5 px-3 py-2 text-sm ${
                          isCorrect
                            ? "bg-green/8 border border-green text-green"
                            : isUser && !isCorrect
                            ? "bg-red-500/8 border border-red-500 text-red-400"
                            : "text-gray-600"
                        }`}
                      >
              ...
              {q.type === "short_answer" && (
                <div className="space-y-1.5 text-sm font-mono">
                  <div className="flex items-start gap-2">
                    ...
                    <span className={correct ? "text-green" : "text-red-400"}>
                  ...
                  {!correct && (
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-green">{q.correctAnswer}</span>
                    </div>
                  )}
                </div>
              )}
