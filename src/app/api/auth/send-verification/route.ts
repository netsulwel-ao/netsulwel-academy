              ...
              <tr>
                <td style="background-color:#0a0a18;padding:36px 20px;text-align:center;font-family:Arial,Helvetica,sans-serif;">
                  <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                    ...
                    <tr>
                      <td style="font-size:11px;color:#7070a0;letter-spacing:2px;text-transform:uppercase;padding-bottom:16px;text-align:center;">Verifica&ccedil;&atilde;o de email</td>
                    </tr>
                    <tr>
                      <td style="text-align:center;">
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto;background-color:#7c3aed;">
                                <tr>
                                  <td style="padding:8px 20px;text-align:center;">
                                    <span style="color:#ffffff;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:700;">VERIFICAR</span>
                                  </td>
                                </tr>
                              </table>
                            </td>
              ...
              <tr>
                <td style="padding:36px 40px 32px;">
                  ...
                  <p style="color:#7070a0;font-size:14px;line-height:1.75;text-align:center;margin:0 0 28px 0;">
                    Bem-vindo à <strong style="color:#a0a0c0;font-weight:500;">Netsulwel Academy</strong>!<br/>
                  ...
                  <p style="color:#4a4a6a;font-size:12px;text-align:center;margin:0 0 16px 0;letter-spacing:0.3px;">
                    Se criaste esta conta, clica no botão abaixo:
                  </p>

                  <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
                    <tr>
                      <td align="center" style="background-color:#7c3aed;border-radius:8px;">
                        <a href="${verifyLink}" target="_blank" style="color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;display:inline-block;padding:14px 44px;letter-spacing:0.3px;">
                          Verificar email
                        </a>
                      </td>
                    </tr>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;background-color:#0a0a16;border:1px solid #1a1a30;border-radius:8px;margin-bottom:28px;">
                    <tr>
                      <td style="padding:12px 16px;word-break:break-all;">
                        <a href="${verifyLink}" style="color:#7c3aed;font-size:11px;text-decoration:none;line-height:1.6;">${verifyLink}</a>
                      </td>
                    </tr>
                  </table>

                  <p style="color:#2e2e48;font-size:12px;line-height:1.7;text-align:center;margin:0;">
                    Este link expira em <strong style="color:#4a3a7a;">24 horas</strong> por razões de segurança.<br/>
  ...
  try {
    ...
    try {
      verifyLink = await admin.auth().generateEmailVerificationLink(email, {
        url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://netsulwel.tech"}/verify-email`,
