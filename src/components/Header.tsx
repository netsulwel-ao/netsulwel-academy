...
export function Header() {
    ...
    <header className="fixed top-0 z-50 w-full border-b border-gray-800/60 bg-gray-900/40 backdrop-blur-xl">
      <div className="mx-auto flex min-h-[5rem] max-w-6xl items-center justify-between px-6 py-2 sm:min-h-[6rem]">
        <Link href="/" className="flex items-center gap-3 sm:gap-4">
          <img src="/Logo-Academy-White.svg" alt="Netsulwel Academy" className="h-20 w-auto sm:h-24" />
 ...
 <a
 href="#planos"
 className="mt-2 flex items-center justify-center gap-2 bg-green py-3 font-semibold text-gray-900"
 onClick={() => setOpen(false)}
 >
 Começar agora
 <ArrowRight className="h-4 w-4" />
