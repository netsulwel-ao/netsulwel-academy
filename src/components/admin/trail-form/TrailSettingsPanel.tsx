...
export function TrailSettingsPanel({
  ...
  return (
    <div className="w-full lg:w-[340px] shrink-0 border-b lg:border-b-0 lg:border-r border-gray-800/60 overflow-y-auto p-6 space-y-6">

      {/* Thumbnail */}
      <div>
        <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// capa da trilha</p>
        <div
      ...
      {/* Tipo de acesso */}
      <div>
        <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// tipo de acesso</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// nível</p>
        ...
        <div>
          <p className="font-mono text-[9px] uppercase tracking-[0.2em] text-gray-600 mb-2">// categoria</p>
